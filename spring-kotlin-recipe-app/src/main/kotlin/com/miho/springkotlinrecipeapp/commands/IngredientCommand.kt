...
data class IngredientCommand(var id: Long = -1, var recipeId: Long = -1, var description: String = "", var amount: BigDecimal = BigDecimal.ZERO, var unitOfMeasure: UnitOfMeasureCommand? = null) {
